...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "sort-active-sessions", String(localized: "settings.app.sortByActiveSessions", defaultValue: "Sort by Active Sessions"), "agent working attention session machine sidebar order"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.sortByActiveSessions": settingID(for: .app, idSuffix: "sort-active-sessions"),
