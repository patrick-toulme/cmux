...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:sort-active-sessions": localized("settings.search.alias.setting.app.sort-active-sessions", defaultValue: "app.sortByActiveSessions sort active sessions agent working attention approval machine section sidebar order bubble"),
